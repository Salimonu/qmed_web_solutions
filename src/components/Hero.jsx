  ...
  return (
    <section className="hero text-white z-10">
      <div className="absolute top-20 left-80">
        ...
        <a
          href="#"
          className="pulse font-semibold py-1 px-2 bg-blue-50 text-blue-900 text-3xl rounded-xl inline-block mr-4 hover:scale-110 duration-1000"
        >
          HIRE ME
        </a>
        <a
          href="#"
          type="button"
          className="font-semibold text-2xl py-1 px-2 outline-1 outline-white rounded-xl inline-block mr-4 hover:scale-110 duration-1000"
        >
          VIEW MY WORK &darr;
        </a>
      </div>
